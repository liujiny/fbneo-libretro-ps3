...
static void SetInputDescriptors()
{
	...
	const char *driver_name = BurnDrvGetTextA(DRV_NAME);
	if (driver_name && strncmp(driver_name, "gaiapols", 8) == 0) {
		bprintf(0, _T("[PS3 GAIAPOLS] optional input descriptors skipped"));
		return;
	}
#endif
