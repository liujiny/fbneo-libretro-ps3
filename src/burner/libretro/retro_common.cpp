...
#endif
INT32 g_audio_samplerate              = FBNEO_DEFAULT_AUDIO_RATE;
...
#if defined(__PS3__)
	// Ignore stale 48 kHz core-option values on the PPU-limited PS3 build.
	g_audio_samplerate = FBNEO_DEFAULT_AUDIO_RATE;
#else
